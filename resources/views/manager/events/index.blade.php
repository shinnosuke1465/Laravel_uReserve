            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-4 mx-auto">
                ...
                <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                  <button onclick="location.href='{{ route('events.create')}}'" class="flex ml-auto text-white bg-indigo-500 border-0 mb-4 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
                </div>
              </div>
            </section>
